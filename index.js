...
const streets = [
    'Cooper Street', 'Oakwood Court', 'Depot Road', 'Rr. Woodbridge', 'Lower River St.',
    'Bohemia Drive Daphne', 'Ramblewood Ave. Roanoke', 'Hall Dr. Stillwater', 'Beechwood Street Waukegan',
    'York St. Enfield', 'Kirkland Road Lafayette', 'Leatherwood St. Muncie', 'Portsmouth', 'East Church Ave. Glasgow', 'Country Circle Eden Prairie', 'Albany Ave. Pikesville'
]

const randomNatural = (min, max) => {
